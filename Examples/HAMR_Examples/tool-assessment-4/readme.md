...
- The [CASE-Tool-Assessment-AADL-Guide](doc/CASE-Tool-Assessment-Guide.pdf) summarizes the currently supported CASE-supported AADL subset as well as CASE-specific AADL properties that are used to configure and direct CASE tools.
