  ...
  case Some(o: Cli.TranspileOption) =>
    if(o.legacy) {
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--name", "main",
        "--apps", "pfc.producer_t_producer_producer_App,pfc.filter_t_filter_filter_App,pfc.consumer_t_consumer_consumer_App,pfc.LegacyDemo",
        "--fingerprint", "3",
        "--bits", "32",
        "--string-size", "256",
        "--sequence-size", "8",
        "--sequence", s"IS[Z,art.Bridge]=3;MS[Z,Option[art.Bridge]]=3;IS[Z,art.UPort]=2;IS[Z,art.UConnection]=2;IS[Z,B]=288",
        "--constants", s"art.Art.maxComponents=3;art.Art.maxPorts=8",
