...
#
APPS="Demo UxAS_thr_Impl_uxas_UxAS_thread_App RadioDriver_thr_Impl_radio_RadioDriver_App CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_App"
for APP in ${APPS}; do
  pkill -f -SIGTERM $APP
done
ME=`whoami`
