...
case "${SCHEDULER}" in
  legacy)
    ...
    launch "UxAS_thr_Impl_uxas_UxAS_thread_App${EXT} RadioDriver_thr_Impl_radio_RadioDriver_App${EXT} CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_App${EXT}";
