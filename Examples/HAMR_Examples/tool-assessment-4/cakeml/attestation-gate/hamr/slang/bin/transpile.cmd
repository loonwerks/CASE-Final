  ...
  case Some(o: Cli.TranspileOption) =>
    if(o.legacy) {
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--name", "main",
        "--apps", "attestation_gate.UxAS_thr_Impl_uxas_UxAS_thread_App,attestation_gate.RadioDriver_thr_Impl_radio_RadioDriver_App,attestation_gate.CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_App,attestation_gate.LegacyDemo",
        "--fingerprint", "3",
        "--bits", "32",
        "--string-size", "256",
        "--sequence-size", "18",
        "--sequence", s"IS[Z,art.Bridge]=3;MS[Z,Option[art.Bridge]]=3;IS[Z,art.UPort]=7;IS[Z,art.UConnection]=7;IS[Z,B]=131072",
        "--constants", s"art.Art.maxComponents=3;art.Art.maxPorts=18",
