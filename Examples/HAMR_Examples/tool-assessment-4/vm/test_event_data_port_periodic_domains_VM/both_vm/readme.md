...
|System: [top_impl_Instance](aadl/test_event_data_port_periodic_domains.aadl#L94) Properties|
|--|
|Domain Scheduling|
|Wire Protocol|
...
To run HAMR Codegen, select [this](aadl/test_event_data_port_periodic_domains.aadl#L94) system implementation in FMIDE's outline view and then click the
