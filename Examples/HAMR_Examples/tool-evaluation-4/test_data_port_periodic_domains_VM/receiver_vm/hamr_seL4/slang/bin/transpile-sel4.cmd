...
val emitter_t_impl_src_process_src_thread: ISZ[String] = ISZ(
  ...
  "--exclude-build", "receiver_vm.test_data_port_periodic_domains.emitter_t_impl_src_process_src_thread,receiver_vm.test_data_port_periodic_domains.consumer_t_impl_dst_process_dst_thread",
  "--lib-only",
  "--verbose")
