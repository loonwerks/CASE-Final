...
import receiver_vm.test_data_port_periodic_domains.consumer_t_impl_dst_process_dst_thread_seL4Nix

object dst_thread extends App {

  val dst_threadBridge : receiver_vm.test_data_port_periodic_domains.consumer_t_impl_dst_process_dst_thread_Bridge = {
