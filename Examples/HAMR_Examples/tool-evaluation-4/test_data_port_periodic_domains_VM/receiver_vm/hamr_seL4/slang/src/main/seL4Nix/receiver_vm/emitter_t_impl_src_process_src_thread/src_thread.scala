...
import receiver_vm.test_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_seL4Nix

object src_thread extends App {

  val src_threadBridge : receiver_vm.test_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge = {
