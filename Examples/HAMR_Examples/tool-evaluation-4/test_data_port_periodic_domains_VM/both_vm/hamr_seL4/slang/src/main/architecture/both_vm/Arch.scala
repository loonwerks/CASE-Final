...
object Arch {
  val top_impl_Instance_src_process_src_thread : both_vm.test_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge = {
  ...
  val top_impl_Instance_dst_process_dst_thread : both_vm.test_data_port_periodic_domains.consumer_t_impl_dst_process_dst_thread_Bridge = {
