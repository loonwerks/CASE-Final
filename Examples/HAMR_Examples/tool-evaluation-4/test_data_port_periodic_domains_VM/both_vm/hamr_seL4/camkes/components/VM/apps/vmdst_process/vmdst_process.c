...
bool api_get_read_port__both_vm_test_data_port_periodic_domains_consumer_t_impl_dst_process_dst_thread(STACK_FRAME S8 *value);
...
void run(void) {
  ...
  for(;;) {
    ...
    S8 value;
    if(api_get_read_port__both_vm_test_data_port_periodic_domains_consumer_t_impl_dst_process_dst_thread(&value)) {
...
bool api_get_read_port__both_vm_test_data_port_periodic_domains_consumer_t_impl_dst_process_dst_thread(STACK_FRAME
  S8 *value){
