...
bool api_get_read_port__receiver_vm_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer(STACK_FRAME S8* value);
...
void run(void){
  ...
  for(;;) {
    ...
    S8 value;
    if(api_get_read_port__receiver_vm_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer(SF &value)) {
 ...
 **********************************************************************/
 bool api_get_read_port__receiver_vm_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer(STACK_FRAME 
   S8* value){
