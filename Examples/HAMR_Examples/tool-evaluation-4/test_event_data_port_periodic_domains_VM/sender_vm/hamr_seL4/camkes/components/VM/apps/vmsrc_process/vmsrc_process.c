...
void api_put_write_port__sender_vm_test_data_port_periodic_domains_emitter_t_impl_src_process_src_thread(STACK_FRAME S8 value);
...
void run(void) {
  ...
  for(;;) {
    ...
    api_put_write_port__sender_vm_test_data_port_periodic_domains_emitter_t_impl_src_process_src_thread(SF value);
...
void api_put_write_port__sender_vm_test_data_port_periodic_domains_emitter_t_impl_src_process_src_thread(
  S8 value){
  DeclNewsender_vm_Base_Types_Integer_8_Payload(payload);
  payload.value = value;
