...
val source_thread_impl_source_process_component_source_thread_component: ISZ[String] = ISZ(
  ...
  "--output-dir", s"${SCRIPT_HOME}/../../camkes/slang_libraries/source_thread_impl_source_process_component_source_thread_component",
...
val destination_thread_impl_destination_process_component_destination_thread_component: ISZ[String] = ISZ(
  ...
  "--output-dir", s"${SCRIPT_HOME}/../../camkes/slang_libraries/destination_thread_impl_destination_process_component_destination_thread_component",
